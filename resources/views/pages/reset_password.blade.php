                        ...
                        <div class="main-container container-fluid">
                            <div class="row row-sm">
                                <div class="card-body mt-2 mb-2">
                                    ...
                                    <p class="mb-4 text-muted fs-13 ms-0 text-start">Enter your new password and confirm it below.</p>
                                    <form method="POST" action="{{ route('password.update') }}" id="resetPasswordForm">
                                        ...
                                        <div class="form-group text-start">
                                            ...
                                            <input class="form-control" placeholder="Enter your new password" type="password" name="password" id="password" required>
                                        </div>
                                        <div class="form-group text-start">
                                            <label class="form-label">Confirm Password</label>
                                            <input class="form-control" placeholder="Confirm your new password" type="password" name="password_confirmation" id="password_confirmation" required>
                                        </div>
                                        <div class="d-grid">
        ...
        Swal.fire({
            ...
            html: `
                <div class="d-flex flex-column align-items-center">
                    ...
                    <small class="mt-3 fs-6">Sit tight! Your new password is just moments away."</small>
                </div>
            `,
