                        ...
                        <div class="row row-sm">
                                ...
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:linear-gradient(135deg,#6366f115,#6366f130);">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24" fill="#6366f1"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5.93 6h-3.02c-.2-1.73-.8-3.3-1.64-4.47C16.37 4.28 18.05 5.87 17.93 8zM12 4.04c.84 1.07 1.44 2.64 1.64 4.47h-3.28c.2-1.83.8-3.4 1.64-4.47zM6.07 8c.12-2.13 1.8-3.72 3.66-4.47C8.8 4.7 8.2 6.27 8 8H6.07zM4.43 10h3.45c-.09.98-.14 1.98-.14 3s.05 2.02.14 3H4.43a8.056 8.056 0 0 1 0-6zm1.64 8h2.79c.31 1.19.76 2.27 1.33 3.18C7.16 20.9 5.65 19.6 6.07 18zM12 20c-.84-1.07-1.44-2.64-1.64-4.47h3.28c-.2 1.83-.8 3.4-1.64 4.47zm1.86-.82c.57-.91 1.02-1.99 1.33-3.18h2.79c.42 1.6-1.09 2.9-4.12 3.18zM16.12 16c.09-.98.14-1.98.14-3s-.05-2.02-.14-3h3.45a8.056 8.056 0 0 1 0 6h-3.45z"/></svg>
                                            </div>
                                            <span class="badge rounded-pill" style="background:#6366f115;color:#6366f1;font-size:11px;">Websites</span>
                                        </div>
                                        <h3 class="fw-bold mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ getAllWebsites() }}">{{ compact_number(getAllWebsites()) }}</h3>
                                        <p class="text-muted small mb-3">All Available Websites</p>
                                        <a href="{{ route('connectedwebsites') }}" class="btn btn-sm w-100" style="background:#6366f115;color:#6366f1;border-radius:8px;font-size:12px;">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:linear-gradient(135deg,#f59e0b15,#f59e0b30);">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="24" width="24"><g><rect fill="none" height="24" width="24"/><g><path fill="#f59e0b" d="M20,6h-3V4c0-1.1-0.9-2-2-2h-6C7.9,2,7,2.9,7,4v2H4C2.9,6,2,6.9,2,8v12c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V8C22,6.9,21.1,6,20,6z M9,4h6v2H9V4z M20,20H4V8h16V20z"/></g></g></svg>
                                            </div>
                                            <span class="badge rounded-pill" style="background:#f59e0b15;color:#f59e0b;font-size:11px;">Models</span>
                                        </div>
                                        <h3 class="fw-bold mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ getModelsCount() }}">{{ compact_number(getModelsCount()) }}</h3>
                                        <p class="text-muted small mb-3">All Business Models</p>
                                        <a href="{{ route('businessmodels') }}" class="btn btn-sm w-100" style="background:#f59e0b15;color:#f59e0b;border-radius:8px;font-size:12px;">
                                            View All <i class="bi bi-arrow-right ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-3">
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:linear-gradient(135deg,#10b98115,#10b98130);">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="24" width="24"><g><rect fill="none" height="24" width="24"/><g><path fill="#10b981" d="M17,3H7C5.9,3,5,3.9,5,5v16l2-1.5L9,21l2-1.5L13,21l2-1.5L17,21l2-1.5l2,1.5V5C21,3.9,20.1,3,19,3H17z M17,9H7V7h10V9z M17,13H7v-2h10V13z M13,17H7v-2h6V17z"/></g></g></svg>
                                            </div>
                                            <span class="badge rounded-pill" style="background:#10b98115;color:#10b981;font-size:11px;">Invoices</span>
                                        </div>
                                        <h3 class="fw-bold mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ invoiceCount() }}">{{ compact_number(invoiceCount()) }}</h3>
                                        <p class="text-muted small mb-3">All Created Invoices</p>
                                        <a href="#listinvoices" class="btn btn-sm w-100" style="background:#10b98115;color:#10b981;border-radius:8px;font-size:12px;">
                                            View All <i class="bi bi-arrow-right ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-3">
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:linear-gradient(135deg,#ef444415,#ef444430);">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 640 512" fill="#ef4444"><path d="M96 128a80 80 0 1 0 160 0A80 80 0 1 0 96 128zm224 0a80 80 0 1 0 160 0A80 80 0 1 0 320 128zM32 384c0-53 43-96 96-96h64c53 0 96 43 96 96v16c0 8.8-7.2 16-16 16H48c-8.8 0-16-7.2-16-16v-16zm288 0c0-35.3 28.7-64 64-64h96c35.3 0 64 28.7 64 64v32c0 8.8-7.2 16-16 16H336c-8.8 0-16-7.2-16-16v-32z"/></svg>
                                            </div>
                                            <span class="badge rounded-pill" style="background:#ef444415;color:#ef4444;font-size:11px;">Users</span>
                                        </div>
                                        <h3 class="fw-bold mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ userCount() }}">{{ compact_number(userCount()) }}</h3>
                                        <p class="text-muted small mb-3">All Admin & Staff Users</p>
                                        <a href="{{ route('users.index') }}" class="btn btn-sm w-100" style="background:#ef444415;color:#ef4444;border-radius:8px;font-size:12px;">
                                            View All <i class="bi bi-arrow-right ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="row row-sm g-3 mt-1">
                                ...
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width:44px;height:44px;background:linear-gradient(135deg,#10b98120,#10b98140);">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fw-bold mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ myinvoices() }}">{{ compact_number(myinvoices()) }}</h5>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width:44px;height:44px;background:linear-gradient(135deg,#6366f120,#6366f140);">
                                            ...
                                            <div>
                                                <p class="text-muted mb-0 small">My Websites</p>
                                                <h5 class="fw-bold mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ mywebsites() }}">{{ compact_number(mywebsites()) }}</h5>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width:44px;height:44px;background:linear-gradient(135deg,#f59e0b20,#f59e0b40);">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width:44px;height:44px;background:linear-gradient(135deg,#ef444420,#ef444440);">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" fill="#ef4444" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4S14.21 4 12 4 8 5.79 8 8s1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                                            </div>
                                            <div>
                                                ...
                                                <small class="text-muted" style="font-size:11px;">Current state</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-lg-12 col-xl-12 mt-3">
                                <div class="card custom-card border-0 shadow-sm" style="border-radius:16px;">
                                    <div class="card-header border-0 p-4 pb-0" style="background:transparent;">
                                        ...
                                        <p class="text-muted mb-0" style="font-size:13px;">How many invoices each user created over the last 8 days. Hover to see daily breakdown.</p>
                                    </div>
                                    <div class="card-body p-4">
