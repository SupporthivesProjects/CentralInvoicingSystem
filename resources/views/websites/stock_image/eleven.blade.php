                        ...
                        <td class="invoice_image1" style="background-color: transparent;">
                            ...
                            <table style="width: 100%;height: 400px; width: 100%; border: 1px solid black; border-collapse: collapse;">
                                <tr style="height: 24px;">
                                    <td style="width: 8%; text-align: center; font-family: arial; font-size: 10px; font-weight: 400; border: 1px solid black;">
                                        <b>SR. NO.</b>
                                    </td>
                                    <td style="width: 10%; text-align: center; font-family: arial; font-size: 10px; font-weight: 400; border: 1px solid black;">
                                        <b>QUANTITY</b>
                                    </td>
                                    <td style="width: 35%; text-align: center; font-family: arial; font-size: 10px; font-weight: 400; border: 1px solid black;">
                                        <b>PACK NAME</b>
                                    </td>
                                    <td style="width: 12%; text-align: center; font-family: arial; font-size: 10px; font-weight: 400; border: 1px solid black;">
                                        <b>CREDITS</b>
                                    </td>
                                    <td style="width: 12%; text-align: center; font-family: arial; font-size: 10px; font-weight: 400; border: 1px solid black;">
                                        <b>UNIT PRICE</b>
                                    </td>
                                    <td style="width: 11%; text-align: center; font-family: arial; font-size: 10px; font-weight: 400; border: 1px solid black;">
                                        <b>TOTAL</b>
                                    </td>
                                </tr>
                                ...
                                <tr style="height: 24px;">
                                    <td style="width: 8%; text-align: center; font-family: arial; font-size: 10px; border: 1px solid black;">
                                        {{ $counter++ }}
                                    </td>
                                    <td style="width: 10%; text-align: center; font-family: arial; font-size: 10px; border: 1px solid black;">
                                        1
                                    </td>
                                    <td style="width: 35%; text-align: left; padding-left: 8px; font-family: arial; font-size: 10px; border: 1px solid black;">
                                    ...
                                    <td style="width: 12%; text-align: center; font-family: arial; font-size: 10px; border: 1px solid black;">
                                        {{ $product->credits ?? 0 }}
                                    </td>
                                    <td style="width: 12%; text-align: right; padding-right: 8px; font-family: arial; font-size: 10px; border: 1px solid black;">
                                        {{ $currency . number_format($product->price, 2) }}
                                    </td>
                                    <td style="width: 11%; text-align: right; padding-right: 8px; font-family: arial; font-size: 10px; border: 1px solid black;">
                                        {{ $currency . number_format($product->price, 2) }}
                                    </td>
                                </tr>
                                @endforeach
                                ...
                                <!-- Summary rows -->
                                <tr>
                                    <td colspan="5" style="text-align: right; font-family: arial; font-size: 10px; font-weight: 700; padding-right: 8px; border: 1px solid black;">
                                        SUBTOTAL
                                    </td>
                                    <td style="text-align: right; padding-right: 8px; font-family: arial; font-size: 10px; font-weight: 700; border: 1px solid black;">
                                        {{ $currency . number_format($invoice_amount + $discount_amount, 2) }}
                                    </td>
                                </tr>

                                <tr>
                                    <td colspan="5" style="text-align: right; font-family: arial; font-size: 10px; padding-right: 8px; border: 1px solid black;">
                                        DISCOUNT
                                    </td>
                                    <td style="text-align: right; padding-right: 8px; font-family: arial; font-size: 10px; color: green; border: 1px solid black;">
