                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0"  style="border-collapse: collapse;">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 20px;text-align: end;padding-right:10px;">
                                                                <p style="font-family: 'Roboto';font-size: 9px;line-height: normal;color: gray; padding-top: 20px;">SUB TOTAL<br>
                                                                    DISCOUNT</p>
                                                            </td>
                   ...
                   <div class="invoice-footer" style="
                    ...
                    ">
                        ...
                        <!-- Company Info -->
                        <div style="flex: 1; text-align: right; padding-top: 70px;">
                            <p style="font-family: 'Roboto'; font-size: 9px; font-weight: 400; color: #fff;padding-bottom: 10px;">
                            {{ $company_name }}<br>
                            {!! $company_address !!}<br>
                            </p>
                            <p style="font-family: 'Roboto'; font-size: 9px; font-weight: 400; color: #fff; padding: 5px 0;padding-bottom: 15px;">
                            {{ $site->company_mobile }}
                            </p>
