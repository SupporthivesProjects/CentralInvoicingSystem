                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.1);background: url('{{ $invoice_image1 }}');background-repeat: no-repeat;background-position: center;background-size: cover;height:900px;">
                    ...
                    <tr style="height:170px;">
                        <td style="padding:20px 24px;vertical-align: top;">
                            <div style="border: 1px solid #198AB1;
                                padding: 8px 16px;
                                border-radius: 8px;
                                box-shadow: 4px 4px 0px 0px #BA12F7;background: #FFFFFF;">
                                <div style="display: flex;flex-direction: row;justify-content:space-between;gap: 16px;">
                                    <div style="display: flex;flex-direction: row;justify-content:space-between;">
                                        <h1 style="color: #198AB1;margin:0px;">Invoice</h1>
                                    </div>
                    ...
                    <tr>
                        <td style="padding:10px 24px 30px 24px;vertical-align: top;" align="center">
                            <div style="border: 1px solid #198AB1;
                                border-radius: 8px;
                                box-shadow: 4px 4px 0px 0px #BA12F7;background: #FFFFFF;min-height:440px;
    position: relative;">
                            <table style="border-collapse: collapse;width:100%;">
                                <tr style="border-bottom: 1px solid #198bb1;">
                                    <td style="padding: 10px;width: 40%;padding-left:30px;">
