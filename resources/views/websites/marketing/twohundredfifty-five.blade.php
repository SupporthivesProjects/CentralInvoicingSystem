        ...
        <tr>
            <td align="center" bgcolor="#f2f2f2" style="padding: 20px 0;">
                <table width="800" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff"
                    style="border-collapse: collapse; box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.1); background-image: url(./img/fluxbg_page.jpg); background-position: center; background-repeat: no-repeat; background-size: cover;">
                    <!-- Header -->
                    <tr>
                        <td style="padding: 100px 0px; position: relative;">
                            <div style="position: absolute; top: 80px; right: 175px;">
                                <p
                    ...
                    <tr>
                        <td
                            style="padding:0px 60px 170px 60px;background-position: center;background-size: cover;height:444px;">
                                        ...
                                        <div
                                            ...
                                            <div class="info_left">
                                                <div class="l_top" style="display: flex;flex-direction: row;">
                                                    <div
                                                        style="padding: 10px; background-color: #F2F2F2; width: 130px; border: 1px solid grey;">
                                                        <p
                                                    ...
                                                    <div
                                                        style="padding: 10px; background-color: #F2F2F2; width: 130px; border: 1px solid grey; border-left: none;">
                                                        <p
                                                            style="color:#000000; text-align:start;padding:10px;font-family:  Arial;font-size:10px;margin: 0px;font-weight: 400;">
                                                            {{ $invoice_number }}
                                                        </p>
                                                ...
                                                <div class="l_top" style="display: flex;flex-direction: row;">
                                                    <div
                                                        style="padding: 10px; background-color: #FFFFFF; width: 130px; border: 1px solid grey; border-top: none;">
                                                        <p
                                                            style="color:#000000; text-align:start;padding:10px;font-family:  Arial;font-size:10px;margin: 0px;font-weight: 400;">
                                                            Invoice Date.
                                                        </p>
                                                    ...
                                                    <div
                                                        style="padding: 10px; background-color: #FFFFFF; width: 130px; border: 1px solid grey; border-left: none; border-top: none;">
                                                        <p
                                                            style="color:#000000; text-align:start;padding:10px;font-family:  Arial;font-size:10px;margin: 0px;font-weight: 400;">
                                                            {{ $invoice_date }}
                                                        </p>
                                            ...
                                            <div class="info_right"
                                                style="width: 300px; border: 1px solid grey; padding: 5px; display: flex; flex-direction: column; gap: 8px;">
                                                <p
