              ...
              <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  ...
                  <td width="60%" valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" style="font-size:11px; line-height:18px; font-family:Arial;">
                      <tr>
          ...
          <tr>
            <td>
              <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="font-size:14px; line-height:18px;">
                    <img src="{{ $invoice_image3 }}" alt="" style="position: absolute ;   width: 30px;top: -47px;left: 10px;">
                    <strong>To:</strong><br>
          ...
          <tr>
            <td align="center">
              <table cellpadding="0" cellspacing="0" width="500"
                ...
                <tr>
                  <td style="padding:12px 5px; border-bottom:1px solid #3C8F89;"> {{ $product->name }}</td>
                  <td
