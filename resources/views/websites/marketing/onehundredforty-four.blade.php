                   ...
                   <tr>
                    ...
                    <tr style="width: 100%;">
                        <td style="padding:40px;padding-top:0px; width: 100%;">
                            <table style="width: 100%;">
                                <tr style="width: 100%;">
                                    ...
                                    <td style="padding-top: 30px;min-width: 200px;">
                                        ...
                                        <p style="font-family: arial;font-size:10px;margin: 0px;font-weight: 400;padding-bottom: 5px;color: #8C8C8C;">
                                           {{ $customer_mobile }}
                                        </p>
                                        <p style="font-family: arial;font-size:10px;margin: 0px;font-weight: 400;padding-bottom: 5px;color: #8C8C8C;">
                                           {{ $customer_email }}
                                    ...
                                    <td style="padding-top: 10px;min-width: 200px;text-align: right;">
                                       <p style="font-family: arial;font-size: 10px;margin: 0px;font-weight: 400;padding-bottom: 5px;">
                                        ...
                                        <p style="font-family: arial;font-size: 10px;margin: 0px;font-weight: 400;padding-bottom: 5px;color: #8C8C8C;">{{ $company_address }},</p>
                            ...
                            <div style="min-height: 789px !important;">
                            <table style="border-collapse: collapse;border-bottom: 0px;border: 0px;">
                                <tr style="border-collapse: collapse;height: 50px; color: white;border-bottom: 1px solid black;border: 0px;">
                                    ...
                                    <td style="width: 200px;text-align: center;font-family: arial;font-size: 10px;margin: 0px;font-weight: 600;border-collapse: collapse;border-right: 1px solid black;background-color: black;">
                                        <b>	Package Type</b>
                                    </td>
                                    <td style="width: 200px;text-align: center;font-family: arial;font-size: 10px;margin: 0px;font-weight: 600; border-collapse: collapse;padding-left: 5px;border-right: 1px solid black;background-color: black;">
                                        <b>Length</b>
                                    </td>
                                    <td style="padding-right: 10px; width: 200px;text-align:right;font-family: arial;font-size: 10px;margin: 0px;font-weight: 600;border-collapse: collapse;background-color: black;">
                                        <b>Amount</b>
                                    </td>
                                ...
                                <tr style="border-collapse: collapse;height: 60px;border-bottom: 0px;border: 0px;border-bottom: 1px solid black;">
                                    <td style="color: #3C7F79; padding-left: 2px; width: 500px;text-align: left;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;padding-left: 4px;border-right: 1px solid black;">
                                     <b style="color: black">{{ $product->name }}</b>
                                    </td>
                                    <td style="width: 300px;text-align:center;font-family: arial;font-size:10px;margin: 0px;font-weight: 400; border-collapse: collapse;border-right: 1px solid black;">
                                    ...
                                    <td style="width:100px;text-align:center;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;padding-left: 5px;border-right: 1px solid black;">
                                ...
                                <tr style="border-collapse: collapse;height: 30px;border-bottom: 0px;border: 0px;">
                                    ...
                                    <td style="width:100px;text-align:center;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;padding-left: 5px; border-collapse: collapse; ">
                                       Sub Total
                                    </td>
                                    <td style="padding-right: 10px; width:100px;text-align:right;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse; ">
                                 ...
                                 <tr style="border-collapse: collapse;height: 30px;border-bottom: 0px;border: 0px;">
                                    <td style="width: 100px;padding-left: 20px; text-align: left;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;">
                                 ...
                                 <tr style="border-collapse: collapse;height: 30px;border-bottom: 0px;border: 0px;">
                                    ...
                                    <td style="width:100px;text-align:center;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;padding-left: 5px; border-collapse: collapse;background-color: #3C7F79;color: white; ">
                                       Grand Total
                                    </td>
                                    <td style="padding-right: 10px; width:100px;text-align:right;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;background-color: #3C7F79;color: white; ">
