                    ...
                    <tr>
                        ...
                        <td style="font-family: 'Inter'; font-size: 9px; vertical-align: top;">
                            ...
                            {{-- <div style="min-height: 700px;"> --}}
                             ...
                             <table width="100%"
                                style="margin-top: -30px;margin-left: 30px; padding: 40px;padding-right:0px; color: White; background-image: url('{{ $invoice_image2}}'); height: 212px; width: 100%; background-position: center; background-repeat: no-repeat; background-size: cover; box-shadow: none;">
                                <tr>
                                    <td width="50%">
