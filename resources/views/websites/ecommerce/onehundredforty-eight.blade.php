                                ...
                                <tr>
                                    ...
                                    <td>
                                     <div style="display: flex; justify-content: center; align-items: center;">
                                         ...
                                         <div class="add-h6" style="width: 120px;">
                                            <div class="linement">
                                                <div class="box">
                                                ...
                                                <h6 style="margin-bottom: 0px;margin-top:8px;" >{{ $company_mobile }}</h6>
                                            </div>
                                           <div class="linement">
                                                <div class="box">
                                                ...
                                                <h6 style="margin-bottom: 0px;margin-top:8px;">{{ $company_email }}</h6>
                                            </div>
                                           <div class="linement">
                                                <div class="box">
                                                ...
                                                <h6 style="margin-bottom: 0px;margin-top:8px;">{{ $site->site_link }}</h6>
                                           </div>
                                           <div class="linement">
                                                <div class="box">
                                               ...
                                               <h6 style="margin-bottom: 0px;margin-top:8px;">{!! $company_address !!}</h6>
                                           </div>
                                        </div>
                                     </div>
                                    </td>
