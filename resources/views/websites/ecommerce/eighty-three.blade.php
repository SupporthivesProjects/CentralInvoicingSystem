            ...
            <td align="center" bgcolor="#f2f2f2" style="padding: 20px 0;">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border-collapse: collapse; box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <!-- Header End -->
                     ...
                     <!-- Content -->
                    <tr>
                        <td style="padding:40px;padding-top: 20px; background: url('{{ $invoice_image1 }}') no-repeat;background-position: center;background-size: cover;height:444px;">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;">
                                <tr>
                                    <td style="width: 500px; ">
                                        <img src="{{ $company_logo }}" alt="" style=" display: block;height: 40px;">
                                         <br>
                                        <br><br>
                                        <p style="font-family: arial;font-size: 10px;margin: 0px;font-weight: 600;">
                                            <strong>BILLED FROM:</strong></p>
                                    ...
                                    text-align: right;">
                                        <h1 style="font-family: arial;font-size: 20px;margin: 0px;font-weight: 700;top: 0px;">INVOICE</h1><br>
                                        <p style="font-family: arial;font-size:10px;margin: 0px;font-weight: 400;">
                            ...
                            <br>
                            <br>
                            <div style="min-height: 570px !important;">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="" border="0px" style="border-collapse: collapse;">
                                <tr style="background: url('{{ $invoice_footer_image }}') no-repeat;background-position: center;background-size: cover;height:141px;padding:50px;background-size:cover;width: 100%;">
                                    <td style="text-align:center;">
                                        <p style="text-align: center;font-family: arial;font-size: 10px;margin: 0px;font-weight:700;color:black;">
                                            WE COULDN’T DO IT WITHOUT CUSTOMERS LIKE YOU.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
