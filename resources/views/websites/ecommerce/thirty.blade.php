        ...
        <tr>
            <td align="center" bgcolor="#f2f2f2" style="padding: 20px 0;">
                <table width="600" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border-collapse: collapse; box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.1);">
                    <tr>
                        <td style="height: 100px; background: url('{{ $invoice_header_image }}') no-repeat;background-position:center;background-size:cover;width: 600px;">

                        </td>
                    </tr>
                    <tr style=" background: url('{{ $invoice_image1 }}') no-repeat;background-position:center;background-size:cover; height: 100%;width: 100%;">
                        <td style="padding:40px;padding-top:20px; height: 100%;">
                            <table>
                                <tr>
                                    <td style="width: 290px;">
                                        ...
                                        <p style="font-family: arial;font-size: 10px;margin-bottom: 5px;font-weight: 400;">
                                            <b>Website:</b> www.devvindra.com</p>
                                        <p style="font-family: arial;font-size: 10px;margin: 0px;font-weight: 400;">
                            ...
                            <table style="border-collapse: collapse;border-bottom: 0px;border: 0px;">
                                <tr style="border-collapse: collapse;height: 30px;background-color: #DDE5F2; border-bottom: 0px;border: 0px;">
                                ...
                                <tr style="border-collapse: collapse;height: 30px;border-bottom: 0px;border: 0px;">
                                 ...
                                 <tr style="border-collapse: collapse;height: 30px;border-bottom: 0px;border: 0px;">
                                    ...
                                    <td style="width:100px;text-align:left;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;background-color: #DDE5F2; padding-left: 5px;">
                                        Grand Total
                                    </td>
                                    <td style="width:100px;text-align:left;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;background-color: #DDE5F2;;">

                                    </td>
                                    <td style="width:100px;text-align:right;font-family: arial;font-size: 10px;margin: 0px;font-weight: 400; border-collapse: collapse;background-color: #DDE5F2;">
