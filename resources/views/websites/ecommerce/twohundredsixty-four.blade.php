        ...
        <tr>
            <td align="center" bgcolor="#f2f2f2" style="padding:0px;">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff"
                    style="border-collapse: collapse; background: url('{{ $invoice_image4 }}'); box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.1);background-size:100% 100%;height:100vh;">
                    <!-- Header -->
                    <tr>
                                ...
                                <tr style="position: relative;">
                                    <td style="
                                        ...
                                        <table style="margin-left: auto;
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ $company_logo }}" alt="" style="width: 230px; " >
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <table width="100%" cellpadding="8" cellspacing="0" border="0" style="font-size: 10px;">
                                            ...
                                            <tr style="background:#385b4b;color:#ffffff;font-weight:bold; font-size: 10px;font-family:calibri;">
                                                ...
                                                <td width="17%" align="right">Unit Price </td>
                    ...
                    <tr>
                        <td>
                            <table width="100%" cellspacing="0" cellpadding="" border="0px"
                                style="border-collapse: collapse; background-image: url('{{ $invoice_footer_image }}'); background-position: center; background-size: contain; background-repeat: no-repeat; height: 189px;">
                                <tr style="font-size: 10px; font-family: 'Cambria';" >
                                     <td  style="padding-right:20px; padding-left: 123px;">
