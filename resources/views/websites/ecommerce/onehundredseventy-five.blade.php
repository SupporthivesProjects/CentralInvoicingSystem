                        ...
                        <td style="padding:0px 40px 100px 40px; background-color: #161a1c;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div style="display: flex; justify-content: space-between; width: 100%;">
                                            ...
                                            <p style="font-family: Helvetica;color: #FFFFFF; font-size: 8px;margin: 0px; text-align: end; font-weight: 400; line-height: 12px;">
                                                {{ $company_name }}<br>
                            ...
                            <div style="min-height: 657px;">
                                <table style="border-collapse: collapse;" class="striped-table">
                                    ...
                                    <tr style="border-collapse: collapse;height: 24px;">
                                        <td style="width: 80px; color:#000000; text-align: center; padding: 16px 10px;font-family:  Helvetica;font-size: 8px;margin: 0px;font-weight: 400;border-collapse: collapse;">
                                        <b>{{ $loop->iteration }}</b>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 100px;text-align: right;font-family: Helvetica;font-size: 10px;margin: 0px;font-weight: 400;padding-right: 10px; background-color: #161a1c;" colspan="3">
                                        </td>
