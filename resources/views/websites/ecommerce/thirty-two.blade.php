        ...
        <tr>
            <td>
                <table width="100%" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td
                            style="background: url('{{ $invoice_header_image }}')no-repeat; background-size:  cover; height: 200px; background-position:  center center;">
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px 40px;">
                            <table style="padding-left: 50px;">
                                <tr>
                                    ...
                                    <td>
                                        <h2
                                            style="font-family: arial;font-size: 30px;margin: 0px;font-weight: 700;padding-right: 50px;">
                                            <b>INVOICE</b></h2>
                                    </td>
                                </tr>
                                    ...
                                    <table style="border-spacing: 50px 40px;">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div
                                                        style="background: url('{{ $invoice_image1 }}') no-repeat; background-position: center center; background-size: cover;width: 240px; height: 200px; max-width: 100%; display: flex;flex-direction: column;justify-content: end;padding-bottom: 25px; margin: auto;text-align: center;">
                                                        <p
                                                            style="font-family: arial;font-size: 15px;margin: 10px;font-weight: 400;">
                                                            Phone </p>
                                                        <p
                                                ...
                                                <td>
                                                    <div
                                                        style="background: url('{{ $invoice_image2 }}') no-repeat; background-position: center center; background-size: cover;width: 240px; height: 200px; max-width: 100%; display: flex;flex-direction: column;justify-content: end;padding-bottom: 24px;  margin: auto;text-align: center;">
                                                        <p
                                                            style="font-family: arial;font-size: 15px;margin: 3px;font-weight: 400;">
                                                            Address</p>
                                                        <p
                                                ...
                                                <td>
                                                    <div
                                                        style="background: url('{{ $invoice_image3 }}') no-repeat; background-position: center center; background-size: cover;width: 240px; height: 200px; max-width: 100%; display: flex;flex-direction: column;justify-content: end;padding-bottom: 24px;  margin: auto;text-align: center;">
                                                        <p
                                                            style="font-family: arial;font-size: 15px;margin: 10px;font-weight: 400;">
                                                            Email</p>
                                                        <p
                                                            style="font-family: arial;font-size: 15px; margin: 0px; font-weight: 400; margin-bottom: 0px; margin-top: 5px;">
                                                            {{ $company_email ?? 'support@gaviservices.com' }}
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
