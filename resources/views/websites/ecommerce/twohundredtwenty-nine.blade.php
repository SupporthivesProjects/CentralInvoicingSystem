                                ...
                                <tr style="border-collapse: collapse;">
                                    ...
                                    <td colspan="5"
                                        ...
                                        <div style="display: flex; flex-direction: row; justify-content: flex-end;">
                                            <div style="display: flex; flex-direction: row;justify-content: space-between;gap: 8px;align-items: center;background-color: white;width: 400px; border-radius:10px; height: 40px ">
