            ...
            <td align="center">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border-collapse: collapse; box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 0px 0px 0px 40px;">
                            <div style="display: flex; align-items: flex-start;">
                                <div style="position: relative; top: -34px; min-height: 200px !important; ">
                    ...
                    <!-- from to -->
                     ...
                     <!-- Footer -->
                     <tr>
                        <td style="background: linear-gradient(to right, #e03b42 35%, #202020 35%); padding: 60px 40px 50px 40px; display: flex; justify-content: space-between;">
