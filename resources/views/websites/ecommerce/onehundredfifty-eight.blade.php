...
<body>
    <table style="width:100%; margin: 0 auto; border-collapse: collapse;min-height: 1115px;">
        <tr>
            <!-- Left Side -->
            <td
                style="width: 200px; vertical-align: top; background-color: #ffffff; background-image: url('{{ $invoice_image5 }}'); background-repeat: repeat-y; background-size: cover; padding: 20px; min-height: 1115px;">
