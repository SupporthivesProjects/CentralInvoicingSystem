        ...
        <tbody>
                                                ...
                                                <tr style="display: flex; justify-content:space-between; gap: 24px; padding-top:0px;">
                                                    <td style="width: 22%;padding-bottom: 24px;">
                                                        ...
                                                        <div style="background: #8EBCD4; padding: 6px; width: 24px; height: 24px;">
                                                            <img src="./img/locaton.png" alt="" class="img-fluid" style="width: 14px; height: 14px;max-width: 100%;object-fit: cover;">
                                                        </div> Address</h6>
                                                        <p style="font-family: Arial;font-size: 10px; font-weight: 400; line-height: normal; color: #000;">
                                                            Block B, Office-B27-008, 
                                                            SRTI Park, in the Emirate
                                                                of Shar¬jah, U.A.E
                                                        </p>
                                                    </td>
                                                    <td style="padding-left: 20px; padding-bottom: 24px;border-left: 1px solid #000;">
                                                        <h6 style="display: flex;justify-content: left; gap: 10px; align-items: center; font-size: 8px; line-height: normal; color: #000; font-weight: 400;">
                                                            <div style="background: #8EBCD4; padding: 6px; width: 24px; height: 24px;">
                                                                <img src="./img/call.png" alt="" class="img-fluid" style="width: 14px; height: 14px;max-width: 100%;object-fit: cover;"></div>
                                                            Phone</h6>
                                                        <p style="font-family: Arial;font-size: 10px; font-weight: 400; line-height: normal; color: #000;">
                                                            00971-562786451
                                                        </p>
                                                    ...
                                                    <td style="padding-left: 20px; padding-bottom: 24px;border-left: 1px solid #000;">
                                                        <h6 style="display: flex;justify-content: left; gap: 10px; align-items: center; font-size: 8px; line-height: normal; color: #000; font-weight: 400;">
                                                        <div style="background: #8EBCD4; padding: 6px; width: 24px; height: 24px;">
                                                            <img src="./img/internet.png" alt="" class="img-fluid" style="width: 14px; height: 14px;max-width: 100%;object-fit: cover;">
                                                        </div>
                                                            Email
                                                        </h6>
                                                        <p style="font-family: Arial;font-size: 10px; font-weight: 400; line-height: normal; color: #000;">
                                                            support@fillyourpage.com
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width: 100%;">
                                                    ...
                                                    <p style="font-family: Arial;font-size: 8.5px; font-weight: 400; line-height: normal; color: #000;margin-bottom: 4px;">21 Jan 2025</p>
                                                    <p style="font-family: Arial;font-size: 8.5px; font-weight: 400; line-height: normal; color: #000;margin-bottom: 10px;">Invoice No: # 344293419</p>
                                                </td>
                                                <td style="width: 50%;">
                                                    <div style="display: flex; gap: 24px; width: 113px;">
                                                        <div style="background: #8EBCD4; padding: 6px; width: 29px; height: 28px;">
                                                            <img src="./img/mony.png" style="width: 14px; height: 14px;">
                                                        </div>
                                                        <div>
                                                            <h5>Due Amount</h5>
                                                            <h3 style="font-family: Arial; font-size: 15px; font-weight: 600;">$100.00</h3>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <table class="table-list" style="width:100%;border-bottom: 0px; border-left: 0px; border-right: 0px;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <h6>Corporate Content / Website Policies</h6>
                                    <p style="font-family: Arial;font-size: 8px;line-height: normal;font-weight: 500;">
                                        Turnaround / Quality: 2-3 days / Standard Image Qty: 1
                                    </p>
                                    </td>
                                    <td >
                                    <p style="font-family: Arial;font-size: 10px; line-height: normal;font-weight: 400;">2250</p>
                                    </td>
                                    <td>
                            ...
                            <tr>
                                ...
                                <td style="border: 0px;">
                                    <p style="font-family: Arial;font-size: 10px; line-height: normal;font-weight: 400;">$100.00</p>
                                </td>
                            </tr>
                            <tr>
                                <td  colspan="2" style="border:0px;padding: 14px 18px; text-align: left;">
                                ...
                                <td style="border: 0px;">
                                    <p style="font-family: Arial;font-size: 10px; line-height: normal;font-weight: 400;" >$0.00</p>
                                </td>
                            </tr>
                            <tr>
                                <td  colspan="2" style="border:0px;padding: 14px 18px; text-align: left;">
                                ...
                                <td style="border: 0px;background: #8EBCD4; padding: 16px 0px;">
                                    <p style="font-family: 'Lato';font-size: 13px; line-height: normal;font-weight: 600;" >$100</p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td style="padding-top: 50px;">
                        <tfoot>
                            <tr>
                                <td style="background: url(./img/foot-logo-img.png)no-repeat; height: 252px; width: 100%; background-size: contain;">
