            ...
            <td align="center" bgcolor="#f2f2f2" style="padding: 0px 0;">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="border-collapse: collapse; box-shadow: 0px 3px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <!-- Header End -->
                     ...
                     <table style="width: 350px; font-family: Arial, sans-serif; border-collapse: collapse; font-size: 10px;">
                        <tr style="border-bottom: 1px solid #333;border-top: 1px solid #333;">
                          <th style="text-align: left; padding: 8px; font-weight: bold;">Product Name</th>
                          <th style="text-align: left; padding: 8px; font-weight: bold;">Quantity</th>
                          <th style="text-align: right; padding: 8px; font-weight: bold;">Unit Price</th>
                        </tr>
                        ...
                        <tr style="border-bottom: 1px solid #333; ">
                          ...
                          <td style="padding: 8px; text-align: right; vertical-align: top;"> {{ site_currency() }} {{  number_format($product->unit_price, 2) }}</td>
                        </tr>
                        @endforeach
                      </table>
                      <div style="border-top: 1px solid #333; margin: 40px 0; width: 350px; margin-bottom: 0px;"></div>
                    
                      <!-- Totals -->
                      <table style="width: 350px; font-family: Arial, sans-serif; font-size: 10px; border-collapse: collapse;">
                        <tr>
                          <td style="width: 40%;"></td>
                          <td style="text-align: left; padding: 4px; font-weight: bold;">SubTotal</td>
                    ...
                    <td style="height: fit-content;padding: 40px; padding-left: 0px;">
                        ...
                        <p style="font-family: arial;font-size: 12px;font-weight: 400; margin: 0px;color: #414042; ">
                           Grandiose Valley Services Limited
                        </p>
                        <br>
                        <br>
                        <p style="font-family: arial;font-size: 12px;font-weight: 400; margin: 0px;color: #414042; ">
