                            ...
                            <table style="width: 100%; border-collapse: collapse; font-family: Arial, Helvetica, sans-serif; margin-top: 20px;">
                                <tr>
                                  ...
                                  <td style="vertical-align: top; text-align: left; padding-bottom: 10px; width: 30%;">
                                    ...
                                    <hr style="border: none; border-top: 1px solid #5a7b9d; margin: 2px 0 10px 0;">
                                    <div style="font-size: 10px; color: #444;"> {{ $site_name }}</div>
                                ...
                                <table
                                    ...
                                    @foreach($products as $product)
                                        <tr style="border-bottom: 1px solid #ccc;">
                                            <td style="font-size:14px;padding: 8px;"> {{ $product->quantity ?? 1 }}</td>
                                            <td style="font-size:14px;padding: 8px; font-weight: bold;">{{ $product->name }}</td>
                                            <td style="font-size:14px;padding: 8px; text-align: right;">{{ site_currency() }} {{ number_format($product->unit_price, 2) }}</td>
                                            <td style="font-size:14px;padding: 8px; text-align: right;">{{ site_currency() }} {{ number_format(($product->quantity ?? 1) * $product->unit_price, 2) }}</td>
                                        </tr>
                                        @endforeach
                                        <tr>
                                        <td></td>
                                        <td></td>
                                        <td style="font-size:14px;text-align: right;color: #577188; font-variant: small-caps;">Subtotal</td>
                                        <td style="font-size:14px;text-align: right; color: #577188;">{{ site_currency() }} {{ number_format(($invoice_amount + $discount_amount), 2) }}</td>
                                        </tr>
                                        <tr>
                                        <td></td>
                                        <td></td>
                                        <td style="font-size:14px;text-align: right;color: #577188; font-variant: small-caps;">Discount</td>
                                        <td style="font-size:14px;text-align: right; color: #577188;">{{ site_currency() }} {{ number_format($discount_amount, 2) }}</td>
                                        </tr>
                                        <tr>
                                        <td></td>
                                        <td></td>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td style="font-size:14px;text-align: right;font-weight: bold; color: #577188; padding-top: 8px; font-variant: small-caps;">Total</td>
                                        <td style="font-size:14px;text-align: right; font-weight: bold; color: #577188; padding-top: 8px;">{{ site_currency() }} {{ number_format($invoice_amount, 2) }}</td>
                                        </tr>
                                        <tr>
                                        <td></td>
                                        <td></td>
