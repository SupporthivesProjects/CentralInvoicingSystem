                        ...
                        <td style="padding:40px;">
                            ...
                            <table
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    <td style="padding: 10px;font-size: 12px;">1</td>
                                    <td style="padding: 10px;font-size: 12px;">{{$product->name}}</td>
                                    <td style="padding: 10px; text-align: right;font-size: 12px;">{{ site_currency() . number_format($product->unit_price, 2) }}</td>
                                    <td style="padding: 10px; text-align: right;font-size: 12px;">{{ site_currency() . number_format($product->unit_price, 2) }}</td>
                                </tr>
                                @endforeach
                            </table>
                            ...
                            <table style="width: 300px;font-size: 10px; border-collapse: collapse; margin-left: auto">
                              <tr style="border-bottom: 1px solid #ccc;">
                                <td style="padding: 8px; font-weight: bold; color: #666; font-variant: small-caps;font-size: 12px;">Subtotal</td>
