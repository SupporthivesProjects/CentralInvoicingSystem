        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <form method="POST" action="{{ route('customerdetails.store') }}" id="getCustomerForm">
                    ...
                    <!-- Card 1: First 4 fields -->
                    <div class="card custom-card mb-4">
                        <div class="card-body">
                            <h5 class="mb-3">Basic Customer & Invoice Details</h5>
                            <div class="row">
                                <!-- Selected Website -->
                    ...
                    <!-- Card 2: Remaining fields -->
                    <div class="card custom-card">
                        <div class="card-body">
                            <h5 class="mb-3">Selected Website & Company Details  <span class="badge bg-light text-dark border border-secondary">Pre-filled</span></h5>
                            <div class="row">
...
<script>
    ...
    $('#generateInvoiceNumber').on('click', function() {
        ...
        if(!site_name){
            toastr.error('Please select a site first.', 'Error');
            return;
        }
        $.ajax({
