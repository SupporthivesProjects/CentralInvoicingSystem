        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text" data-bs-toggle="modal"
                                            data-bs-target="#sitechangemodel"><i class="fas fa-sync-alt text-primary"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="btn-group">
                                            <button type="button"
                                                class="btn input-group-text dropdown-toggle dropdown-toggle-split"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                <span class="visually-hidden">Toggle Dropdown</span>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item py-1 px-3" href="#"
                                                        id="generateInvoiceNumber"><i
                                                            class="fas fa-sync-alt me-2"></i>Generate</a>
                                                </li>
                                                <li><a class="dropdown-item py-1 px-3" href="#"
                                                        id="copyInvoicenumber"><i class="fas fa-copy me-2"></i>Copy</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-file-invoice"></i></span>
                                        <input type="text" form="generate-invoice-form" class="form-control"
                                            id="invoice_file_name" name="invoice_file_name"
                                            value="{{ old('invoice_file_name') }}" placeholder="Enter Invoice File Name">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" form="generate-invoice-form" id="current_amount"
                ...
                <div class="card custom-card mt-4 border-1 rounded shadow">
                    <div
                        class="card-header bg-white shadow-sm rounded-3 p-3 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                        ...
                        <div class="table-responsive border rounded shadow-sm">
                            <table class="table table-bordered table-hover align-middle mb-0">
                                ...
                                <tbody id="randomize-product-table-body">
                                    <!-- Product rows will be injected here via AJAX -->
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row g-3 mb-4 mx-4">
                            ...
                            <div class="col-md-6 d-flex flex-column">
                                <label for="customizeKeywordInput" class="form-label text-center fw-semibold">Search By
                                    Keyword</label>
                                <div class="input-group bg-light shadow-sm ms-2">
                                    <span class="input-group-text bg-transparent border-0">
                                        <i class="fas fa-search text-muted"></i>
                                    </span>
                                    <input type="text" class="form-control border-0" id="customizeKeywordInput"
                                        placeholder="Enter or Speak product or category name..." id="micBtn"
                                        title="Voice Search">
                                    <button class="btn btn-light border-0" type="button" title="Voice Search"
                                        onclick="startVoiceSearch('customizeKeywordInput','customizeMicIcon')">
                                        <i class="fas fa-microphone text-primary" id="customizeMicIcon"></i>
                                    </button>
                                    <button class="btn btn-primary" type="button" title="Search"
                                        onclick="customizeProducts()">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                <div class="bg-light rounded border shadow-sm p-1 text-center">
                                    ...
                                    <div class="fw-bold text-primary fs-5">{{ site_currency() }}<span
                        ...
                        <div class="rounded shadow-sm p-2">
                            <table id="customize-products-table"
                                class="table table-bordered table-hover align-middle mb-0 table-responsive"
                                ...
                                <thead class="table-dark text-center">
                                    <tr>
                                        ...
                                        <th class="text-center unit-price-header" style="width: 20%;" data-column="3"
                                            data-order="desc">
